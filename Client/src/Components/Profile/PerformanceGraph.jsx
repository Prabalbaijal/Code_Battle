...
//   // Create an array with all 12 months in 'YYYY-MM' format
//   const allMonths = Array.from({ length: 12 }, (_, i) => {
//     const year = new Date().getFullYear(); // current year
//     const month = String(i + 1).padStart(2, "0"); // zero-padded month
//     return `${year}-${month}`;
//   });
...
//         <select
//           className="border p-2 rounded-md w-40 ml-2" // Added ml-2 for margin-left for right shift
//           value={selectedMonth}
//           onChange={(e) => setSelectedMonth(e.target.value)} // Set selected month directly
//         >
//           <option value="">Months</option>
//           {allMonths.map((month) => (
//             <option key={month} value={month}>
//               {formatMonth(month)} {/* Format 'YYYY-MM' to full month name */}
//             </option>
//           ))}
//         </select>
//       </div>
//       <div className="h-60 bg-gray-200 p-4 rounded-lg shadow w-full">
//         {loading ? (
...
//           </ResponsiveContainer>
//         ) : (
//           <p className="text-center text-gray-500">No data available for {selectedMonth ? formatMonth(selectedMonth) : "selected months"}</p>
//         )}
//       </div>
//     </div>
//   );
