...
//               <button onClick={() => handleNavigation('/home')} className="hover:text-gray-300 text-left">Home</button>
//               <Link to="/leaderboard" className="hover:text-gray-300" onClick={() => setIsSidebarOpen(false)}>Leaderboard</Link>
//               <Link to="/practice-mode" className="hover:text-gray-300" onClick={() => setIsSidebarOpen(false)}>Practice</Link>
//               <Link to="/friends" className="hover:text-gray-300" onClick={() => setIsSidebarOpen(false)}>Friends</Link>
//               <Link to="/friendrequests" className="hover:text-gray-300" onClick={() => setIsSidebarOpen(false)}>Requests</Link>
//               <Link to="/profile" className="hover:text-gray-300" onClick={() => setIsSidebarOpen(false)}>Profile</Link>
//               <Link to="/settings" className="hover:text-gray-300" onClick={() => setIsSidebarOpen(false)}>Settings</Link>
//               <button onClick={logoutFunction} className="hover:text-red-500">Logout</button>
//             </nav>
//           </div>
//         </div>
//       )}
